...
import { useNavigation } from "@react-navigation/native"; //gg
...
const EditPersonalInfo = () => {
  ...
  const navigation = useNavigation(); // Access navigation object //gg

  const handlePersonalInfoPress = () => {
    console.log("Personal Information Pressed");
    navigation.navigate("Edit"); //gg
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topSection}>
        ...
        <View style={styles.userInfo}>
          <Text style={styles.userName}>Saman Kumara</Text>
      ...
      {/* Section: Payment History */}
      <TouchableOpacity style={styles.section} onPress={handleSignOutyPress}>
        <Image
